...
const Header = () => {
  return (
    <>
      <div className=" bg-slate-900 flex justify-between items-center p-2">
        <div className="searchbar flex items-center gap-4 p-2 w-full">
          <input
            type="search"
            placeholder="Search"
            className=" text-sm h-10 focus:outline-none active:outline-none w-[23rem] rounded-lg border border-slate-500 p-5"
          />
